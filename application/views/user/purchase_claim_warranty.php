			...
			<div class="ps-page__left">
				<div class="row">
					<div class="col-md-12">		
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="product_code" value="<?=$order['product_code'];?>" class="form-control" readonly/>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Nama Produk:</label>
										<input type="text" name="product_name" value="<?=$order['product_name'];?>" class="form-control" readonly/>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
						...
						<hr>
						<div class="mb-5">
							<button onclick="window.location='<?=user_url('purchase/detail/'.$sale_id)?>';" class="ps-btn ps-btn--outline mt-3 mb-3"><i class="fa fa-reply"></i> Kembali</button>
