...
<body style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; color: #000000;">
	...
	<p style="margin-top: 0px; margin-bottom: 20px;">Klaim garansi Anda di <?=$this->config->item('site_name')?> telah mengalami perubahan status. Berikut ini adalah rincian klaim Anda:</p>
		...
		<tbody>
			<tr>
				<td style="font-size: 14px;	border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">
					...
					<b>Status Sebelumnya:</b> <?=$status?><br /><br />
					<b>Status Baru:</b> <?=$newstatus?><br />
				</td>
			</tr>
		</tbody>
	</table>
	<p style="margin-top: 0px; margin-bottom: 20px;">Silakan cek status klaim Anda di <?=base_url()?>.</p>
