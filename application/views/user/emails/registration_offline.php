...
<body style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; color: #000000;">
	...
	<p style="margin-top: 0px; margin-bottom: 20px;">Terima kasih telah melakukan registrasi produk di <?=$this->config->item('site_name')?>. Berikut ini adalah rincian registrasi Anda:</p>
	<table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
		<thead>
			<tr>
				<td style="font-size: 14px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;" colspan="2">Detail Registrasi</td>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td style="font-size: 14px;	border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">
					<b>Tanggal Registrasi :</b> <?=date('d-m-Y',strtotime($register_date))?><br />
					<b>Nama Toko:</b> <?=$shop_name?><br />
					<b>Keterangan:</b> <?=$notes?><br />
					<b>Produk:</b><br>
