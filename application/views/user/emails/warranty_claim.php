...
<body style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; color: #000000;">
	...
	<p style="margin-top: 0px; margin-bottom: 20px;">Anda telah melakukan klaim garansi produk <?=$product_code?> - <?=$product_name?> di <?=$this->config->item('site_name')?>. Berikut ini adalah rincian klaim Anda:</p>
	...
	<p style="margin-top: 0px; margin-bottom: 20px;">Kami akan memproses klaim Anda, silakan menunggu informasi lebih lanjut dari kami.</p>
