<div class="modal-dialog modal-lg">
	<div class="modal-content">
		...
		<div class="modal-header" style="background:#f5f5f5;">
			<div class="row">
				<div class="col-sm-6 btn-group"><a href="<?php echo $parent; ?>" data-toggle="tooltip" title="Induk" id="button-parent" class="btn btn-default"><i class="fa fa-level-up"></i></a> <a href="<?php echo $refresh; ?>" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" id="button-refresh" class="btn btn-default"><i class="fa fa-refresh"></i></a>
...
$('#button-search').on('click', function() {
	var url = "<?=admin_url('image_manager').'?directory='.$directory;?>";
...
$('#button-upload').on('click', function() {
	$('#form-upload').remove();
	$('body').prepend('<form enctype="multipart/form-data" id="form-upload" style="display: none;"><input type="file" name="userfile" value="" /></form>');
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'userfile\']').val() != '') {
			clearInterval(timer);
			$.ajax({
				url: "<?=admin_url('image_manager/upload').'?directory='.$directory;?>",
				type: 'post',		
				dataType: 'json',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: "<?=admin_url('image_manager/folder').'?directory='.$directory;?>",
			type: 'post',		
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		$.ajax({
			url: "<?=admin_url('image_manager/delete')?>",
			type: 'post',		
			dataType: 'json',
