...
<body style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; color: #000000;">
	...
	<p style="margin-top: 0px; margin-bottom: 20px;">Ada klaim garansi produk <?=$product_code.' - '.$product_name?> tidak dilanjutkan oleh customer di <?=$this->config->item('site_name')?>. Silakan mengembalikan barang tersebut kepada customer.</p>
