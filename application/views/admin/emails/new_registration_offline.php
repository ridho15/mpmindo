...
<body style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 14px; color: #000000;">
	...
	<p style="margin-top: 0px; margin-bottom: 20px;">Ada registrasi produk baru di <?=$this->config->item('site_name')?>. Berikut ini adalah rincian registrasi:</p>
