			...
			<?=form_open($action, 'id="form" role="form" class="form-horizontal"')?>
				...
				<div class="tab-content" style="padding-top:20px;">
					<div class="tab-pane active" id="tab-1">
						...
						<div class="form-group">
							<label class="control-label col-sm-4"><?=lang('entry_distributor')?></label>
							<div class="col-sm-8">
								<select name="warehouse_id" class="form-control">
									<?php foreach ($warehouse as $key => $from) {?>
									<?php if ($key == $warehouse_id) {?>
					...
					<div class="tab-pane" id="tab-3">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="checkbox">
									<?php if ($this->admin->admin_id() < 1 && $this->admin->admin_id() != $admin_id) {?>
									<label>
										<?php if ($active) {?>
