...
defined('PATH_ADMIN')  OR define('PATH_ADMIN', 'office');
defined('PATH_USER')   OR define('PATH_USER', 'user');
defined('INVENTORY_URL') OR define('INVENTORY_URL', 'http://inventory.myhassee.com/');
